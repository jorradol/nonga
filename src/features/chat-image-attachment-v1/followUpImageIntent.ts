...
export function buildNoListingImageAckReply(count: number): string {
  if (count <= 1) {
    return "ได้รับรูปแล้วครับ ต้องการลงประกาศรถคันนี้ใช่ไหมครับ ช่วยพิมพ์ยี่ห้อ รุ่น ปี ราคา และเลขไมล์เพิ่มได้เลยครับ";
  }
  return `ได้รับรูป ${count} รูปแล้วครับ ต้องการลงประกาศรถคันนี้ใช่ไหมครับ ช่วยพิมพ์ยี่ห้อ รุ่น ปี ราคา และเลขไมล์เพิ่มได้เลยครับ`;
}
