...
const DOMAIN_GUIDANCE: Record<ChatV3AutomotiveDomainCategory, string[]> = {
  ...
  finance_credit: [
    "สินเชื่อ/ค่างวดต้องแยก: ราคารถ · เงินดาวน์ · ยอดจัด · อัตรา/วิธีคิดดอกเบี้ย · ระยะผ่อน · ค่างวดโดยประมาณ · ค่าธรรมเนียม/ประกันที่อาจไม่รวม",
    "ข้อเท็จจริงจากผู้ใช้ · สมมติฐาน · ผลประมาณการ · เงื่อนไขจริงจากสถาบันการเงินที่ยังไม่ได้ตรวจ — ต้องแยกให้ชัด",
    "ถ้ามีบล็อกคำนวณ deterministic ให้ใช้ตัวเลขนั้นเท่านั้น ห้ามคำนวณชุดเดียวกันใหม่เอง และห้ามให้บทสรุปตัวเลขขัดกับรายละเอียด",
    "ห้ามเดาดอกเบี้ย เงินดาวน์ หรือระยะผ่อน — ถามเฉพาะค่าที่ขาดเมื่อต้องการผลเฉพาะบุคคล",
    "ห้ามใช้ “ราคาตลาดตอนนี้” / ดอกเบี้ยปัจจุบัน หากไม่มีแหล่งข้อมูลปัจจุบันจริง — ใช้ตัวอย่างสมมติและติดป้าย",
  ...
  usage_maintenance: [
    ...
    "ห้ามเหมารวมชนิดเกียร์ (เช่น CVT) หรือระยะเปลี่ยนน้ำมันเกียร์ให้หลายรุ่น/หลายปีโดยไม่มีฐาน",
    "ลมยาง: อ้างอิงสติกเกอร์/คู่มือผู้ผลิต ห้ามบวก-ลด PSI แบบเหมารวม",
    "ช่วงล่าง/ลดความสูง: ห้ามแนะนำตัดสปริงโช้คเป็นวิธีทั่วไป — ให้ลำดับทางเลือกที่ปลอดภัยกว่าก่อน",
  ...
  fault_diagnosis: [
    ...
    "เบรกจมขณะขับ: ใช้ลำดับเหตุการณ์ของ Safety Layer — ขึ้นต้นด้วยการควบคุมรถทันที ไม่ขึ้นต้นด้วยข้อยกเว้นทางเทคนิค; ห้ามดับเครื่องหรือเข้า P/R ขณะเคลื่อนที่ และห้ามอ้างว่า P/R จะล้อล็อก รถหมุน หรือเกียร์พังเป็นสูตรตายตัว; เบรกจอด/ลดเกียร์/แรงช่วยต้องตามระบบรถ; ห้ามชนวัตถุเป็นวิธีทั่วไป; หลังหยุดห้ามขับต่อ ให้เรียกรถยก — ห้ามทวนลำดับเต็มซ้ำ",
  ],
  insurance_tax_docs: [
