...
const DOMAIN_GUIDANCE: Record<ChatV3AutomotiveDomainCategory, string[]> = {
  ...
  fault_diagnosis: [
    ...
    "เบรกจมขณะขับ: เน้นควบคุมรถและหยุดปลอดภัย ห้ามสูตร “ย้ำเบรกรัว ๆ” ห้ามแนะนำดับเครื่องขณะรถยังเคลื่อนที่เป็นค่าเริ่มต้น ห้ามกล่าวว่าพวงมาลัยเลี้ยวไม่ได้แบบเด็ดขาด ห้ามแนะนำชนวัตถุเป็นวิธีทั่วไป และห้ามใช้สูตรเกียร์หรือเบรกจอดไฟฟ้าเดียวครอบจักรวาล",
  ],
  insurance_tax_docs: [
