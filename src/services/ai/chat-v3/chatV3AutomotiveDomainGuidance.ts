...
const DOMAIN_GUIDANCE: Record<ChatV3AutomotiveDomainCategory, string[]> = {
  ...
  fault_diagnosis: [
    ...
    "เบรกจมขณะขับ: ใช้ลำดับเหตุการณ์ของ Safety Layer — ขึ้นต้นด้วยการควบคุมรถทันที ไม่ขึ้นต้นด้วยข้อยกเว้นทางเทคนิค; ห้ามดับเครื่องหรือเข้า P/R ขณะเคลื่อนที่; เบรกจอด/ลดเกียร์/แรงช่วยต้องตามระบบรถ; ห้ามชนวัตถุเป็นวิธีทั่วไป; หลังหยุดห้ามขับต่อ ให้เรียกรถยก — ห้ามทวนลำดับเต็มซ้ำ",
  ],
  insurance_tax_docs: [
