...
function buildEmergencyGuidance(reason: string): string {
  ...
  if (reason === "brake_failure_in_motion") {
    lines.push(
      "โครงสร้างคำตอบที่ต้องใช้ — เรียงตามลำดับเหตุการณ์ และอธิบายเหตุผลของขั้นตอนสำคัญ ห้ามขึ้นต้นด้วยข้อยกเว้นทางเทคนิค:",
      "1. ตั้งสติและรักษาการควบคุมรถ: จับพวงมาลัยให้มั่น ประคองทิศทาง เพื่อไม่ให้รถเสียหลัก",
      "2. ถอนคันเร่งทันที: ลดกำลังจากเครื่องยนต์ ไม่เร่งความเร็วต่อ",
      "3. เตือนรถรอบข้าง: เปิดไฟฉุกเฉิน และบีบแตรเมื่อปลอดภัย เพื่อให้ผู้ขับอื่นรู้ว่ามีเหตุ",
      "4. ทดลองเบรกอย่างควบคุมตามอาการและระบบรถ: กดหรือย้ำแป้นเบรกเท่าที่ยังควบคุมได้ (ห้ามใช้สูตร “ย้ำเบรกรัว ๆ” เป็นคำตายตัว และห้ามรับรองว่าได้ผลทุกกรณี)",
      "5. ลดความเร็วทีละน้อย: หากเหมาะสมกับประเภทรถ ให้ใช้การลดเกียร์หรือ engine braking ตามประเภทเกียร์และคู่มือ — ห้ามใช้ตำแหน่งเกียร์ D3 → 2 → L เป็นสูตรสำหรับรถทุกคัน",
      "6. ห้ามดับเครื่องขณะรถยังเคลื่อนที่ และห้ามเลือกเกียร์ P/R ขณะรถยังเคลื่อนที่: แยกเหตุผล — การดับเครื่องอาจทำให้แรงช่วยบางระบบลดลงหรือต่างกันตามระบบรถ ส่วนการเข้า P/R อาจทำให้ควบคุมยากขึ้นหรือมีผลต่อเกียร์ แต่ผลที่เกิดต่างกันตามยี่ห้อ รุ่น และระบบเกียร์ จึงให้โฟกัสที่การลดความเร็วอย่างควบคุม ไม่ใช่ทำนายกลไกเดียว",
      "7. ใช้เบรกจอดหรือเบรกจอดไฟฟ้าอย่างระมัดระวังเท่านั้น ตามระบบรถและคู่มือรถคันนั้น — ห้ามเหมารวมวิธีใช้เบรกจอดไฟฟ้าทุกยี่ห้อ/ทุกรุ่น",
      "8. บังคับเลี้ยวไปยังพื้นที่เปิดหรือจุดปลอดภัยที่หยุดได้",
      "9. หลังหยุดห้ามขับต่อ: เปิดไฟฉุกเฉิน เรียกรถยกหรือความช่วยเหลือ และตรวจระบบเบรก",
      ...
      "ห้ามกล่าวว่าการเข้าเกียร์ P/R ขณะเคลื่อนที่จะทำให้ล้อล็อก รถหมุน หรือเกียร์พังแน่นอน — ผลที่เกิดต่างกันตามระบบรถ และยืนยันไม่ได้ว่าทุกคันจะล้อล็อกหรือหมุน",
