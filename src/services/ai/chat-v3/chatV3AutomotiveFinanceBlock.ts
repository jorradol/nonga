...
function formatCompleteBlock(result: FinanceCalcResult): string {
  return [
    "[ผลการคำนวณค่างวดแบบประมาณการ — deterministic / WP-V3-10B/14]",
    "ชนิดอัตรา: flat rate ต่อปี (สูตรเดิมของระบบ) — ไม่ใช่ข้อเสนอสินเชื่อจริง",
    "ติดป้ายว่าเป็นตัวอย่างสมมติสำหรับประเมินเบื้องต้น หากไม่มีแหล่งดอกเบี้ย/โปรปัจจุบันจริง — ห้ามเรียกว่า “ราคาตลาดตอนนี้”",
    ...
    "ยังไม่รวม: ค่าธรรมเนียม พ.ร.บ. ประกัน ทะเบียน และค่าใช้จ่ายออกรถอื่น ๆ (ระบบไม่ได้คำนวณในบล็อกนี้)",
    "Disclaimer: เป็นการประมาณการจากตัวเลขที่ผู้ใช้ให้ ไม่ใช่ผลอนุมัติหรือใบเสนอจากสถาบันการเงิน",
    "คำสั่งบังคับ: ใช้ตัวเลขในบล็อกนี้เท่านั้นเมื่อพูดถึงค่างวดชุดนี้ — ห้ามคำนวณตัวเลขชุดเดียวกันใหม่เอง",
