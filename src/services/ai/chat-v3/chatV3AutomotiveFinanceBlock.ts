...
function formatCompleteBlock(result: FinanceCalcResult): string {
  return [
    ...
    "ยังไม่รวม: ค่าธรรมเนียม พ.ร.บ. ประกัน ทะเบียน และค่าใช้จ่ายออกรถอื่น ๆ (ระบบไม่ได้คำนวณในบล็อกนี้) — ห้ามแต่งค่าธรรมเนียม ประกัน เงื่อนไขสถาบันการเงิน หรือยอด VAT",
    "VAT/ภาษีมูลค่าเพิ่ม: ห้ามคูณค่างวดในบล็อกนี้ด้วย 1.07 อัตโนมัติ และห้ามใช้รถใหม่หรือรถมือสองเป็นเงื่อนไขตัดสิน VAT แบบเหมารวม — หากไม่มีใบเสนอราคาหรือสัญญา ให้คงค่างวดในบล็อกนี้ แนะนำให้ตรวจเอกสาร และห้ามยืนยันว่ายอดชำระจริงเป็นค่างวด×1.07",
