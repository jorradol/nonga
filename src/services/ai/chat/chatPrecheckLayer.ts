...
export function buildPrecheckVisionReply(
  ...
  if (lines.length === 0) {
    return "น้องเอดูภาพแล้วครับ แต่ยังสรุปรายละเอียดสำคัญจากภาพได้ไม่พอ จึงขอข้อมูลเพิ่มจากคุณครับ";
  }
  return [
    "น้องเอวิเคราะห์จากภาพให้เบื้องต้นแล้วครับ (อิงตามสิ่งที่เห็นในภาพเท่านั้น):",
    ...lines,
    "หากจุดไหนไม่ตรง แก้ได้เลยนะครับ เดี๋ยวน้องเอปรับให้ทันทีครับ",
  ].join("\n");
}
