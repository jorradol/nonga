  ...
  return (
    <div className="space-y-6 sm:space-y-10 pb-20">
      <section className="text-left space-y-1.5 max-w-xl">
        <h2 className="font-display font-black text-2xl sm:text-3xl nonga-text-primary flex items-center gap-2">
      ...
      <div
        className="rounded-3xl border p-10 sm:p-14 text-center space-y-4 max-w-lg mx-auto nonga-empty-state nonga-bg-subtle nonga-border"
        data-testid="public-dealers-empty-state"
      >
        <div className="w-14 h-14 mx-auto rounded-full bg-[color-mix(in_srgb,var(--nonga-brand)_12%,transparent)] flex items-center justify-center text-orange-500">
          <Store className="w-7 h-7" />
        </div>
        <p className="text-sm sm:text-base nonga-text-secondary leading-relaxed">
