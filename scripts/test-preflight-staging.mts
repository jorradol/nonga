...
ok("expected cloud run revision", EXPECTED_CLOUD_RUN_REVISION === "nonga-staging-00214-89g");
...
ok(
  ...
  getCloudRunRevision({
    status: { latestReadyRevisionName: "nonga-staging-00214-89g" },
  }) === "nonga-staging-00214-89g"
);
