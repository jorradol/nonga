/**
 * v17.8 owner final review index validator
...
const DOC_PATH = "docs/v17.8-owner-final-review-index.md";
const FIXTURE_PATH = "docs/examples/v17.8-owner-final-review-index.synthetic.json";
...
console.log("=== v17.8 Owner Final Review Index Validation ===\n");
...
ok(
  "doc/fixture identify v17.8 correctly",
  /v17\.8 — Owner Final Review Index/.test(doc) &&
    fixtureRaw.includes("\"version\": \"v17.8\"") &&
    fixtureRaw.includes("\"executionType\": \"owner-final-review-index only\"")
);

ok(
  "status is index-only review-only no-execution placeholder-only not-owner-approval not-go",
  hasEveryLine(doc, [
...
const requiredSections = [
  ...
  "v17DocumentIndexSection",
  "v17DocumentPurposeMapSection",
  "ownerReviewChecklistSection",
...
if (packageParsed && typeof packageParsed === "object") {
  ...
  ok("package has test:v17.8 script", scripts["test:v17.8"] === "tsx scripts/test-v178-owner-final-review-index.mts");
}
...
if (fixtureParsed && typeof fixtureParsed === "object") {
  ...
  ok("baseline object complete", baseline["v17.7"] === "VERIFIED VIA V17.7A RECONCILIATION" && baseline["v17.8"] === "INDEX-ONLY / REVIEW-ONLY / NO-EXECUTION / PLACEHOLDER-ONLY");
  ...
  const v17Index = asRecord(root.v17DocumentIndex);
  ok(
    "v17 document index covers v17.0-v17.8 with non-approval flags",
    !!v17Index["v17.0"] &&
      !!v17Index["v17.1"] &&
      !!v17Index["v17.2"] &&
      !!v17Index["v17.3"] &&
      ...
      !!v17Index["v17.7"] &&
      !!v17Index["v17.8"] &&
      v17Index.indexIsNotApproval === true &&
      v17Index.indexIsNotExecutionPath === true
  );

  const v17PurposeMap = asRecord(root.v17DocumentPurposeMap);
  ok(
    "v17 purpose map covers v17.0-v17.8",
    !!v17PurposeMap["v17.0"] &&
      !!v17PurposeMap["v17.1"] &&
      !!v17PurposeMap["v17.2"] &&
      !!v17PurposeMap["v17.3"] &&
  ...
  ok(
    "owner review checklist complete",
    Array.isArray(root.ownerReviewChecklist) &&
      root.ownerReviewChecklist.includes("review readiness summary") &&
      root.ownerReviewChecklist.includes("review decision packet") &&
      root.ownerReviewChecklist.includes("review request draft") &&
      root.ownerReviewChecklist.includes("review checklist") &&
      root.ownerReviewChecklist.includes("confirm still no GO") &&
      root.ownerReviewChecklist.includes("confirm no real values in docs") &&
      root.ownerReviewChecklist.includes("confirm future request must be separate") &&
      root.ownerReviewChecklist.includes("confirm fresh owner approval required")
  );
}

const indexedPaths = [
  "docs/v17.0-future-execution-request-draft-skeleton.md",
  "docs/v17.1-owner-review-packet-future-execution-request.md",
  "docs/v17.2-future-real-value-request-draft-template.md",
  "docs/v17.3-future-real-value-insertion-gate-review.md",
  "docs/v17.4-future-real-value-insertion-request-checklist.md",
  "docs/v17.5-future-real-value-insertion-request-draft.md",
  "docs/v17.6-future-real-value-insertion-owner-review-decision-packet.md",
  "docs/v17.7-final-future-real-value-request-readiness-summary.md",
  "docs/v17.8-owner-final-review-index.md"
];
ok("indexed files exist in repo", indexedPaths.every((path) => existsSync(path)));
ok("doc includes indexed file paths", hasEveryLine(doc, indexedPaths));
...
ok(
  "doc includes owner review checklist lines",
  hasEveryLine(doc, [
...
console.log(`\nDone v17.8 validation - ${pass} PASS, ${fail} FAIL.\n`);
